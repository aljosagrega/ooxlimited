...
| `src/app/(public)/[[...slug]]/page.tsx` | serves the frozen page: `applyChromePatch` (nav/social/contact from JSON) → `applyPageEdits` (pagemap edits from `pages.json`) → `<FrozenView>`. |
