...
class Assets {
    ...
    public function admin_styles(): void {
        if ( $this->is_onboarding_admin_page() ) {
    ...
    public function admin_scripts(): void {
        if ( $this->is_onboarding_admin_page() ) {
            ...
            $plugin_updates  = ( $update_plugins instanceof \stdClass && ! empty( $update_plugins->response ) )
            ...
            $localize_data = array(
                ...
                'translations'            => array(
                    ...
                    'hostinger_easy_onboarding_selected_plugin'                                     => __( 'plugin selected', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_selected_plugins'                                    => __( 'plugins selected', 'hostinger-easy-onboarding' ),
                    ...
                    'hostinger_easy_onboarding_kodee_banner_subtitle'                               => __( 'I’m Hostinger Agent – your AI WordPress assistant', 'hostinger-easy-onboarding' ),
                    ...
                    'hostinger_easy_onboarding_kodee_banner_install'                                => __( 'Install Hostinger Agent', 'hostinger-easy-onboarding' ),
                    ...
                    'hostinger_easy_onboarding_confirm'                                             => __( 'Confirm', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_plugins_add_new_features_and_functionality'          => __( 'Plugins add new features and functionality to your WordPress site.', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_visit_site'                                          => __( 'Visit site', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_dashboard'                                           => __( 'Dashboard', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_install'                                             => __( 'Install', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_home'                                                => __( 'Home', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_set_up_your_website'                                 => __( 'Set up your website', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_steps_completed'                                     => __( 'steps completed', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_discover'                                            => __( 'Discover', 'hostinger-easy-onboarding' ),
                    'hostinger_ai_assistant_welcome_back'                                           => __( 'Welcome back', 'hostinger-easy-onboarding' ),
                    'hostinger_ai_assistant_placeholder'                                            => __( 'Type what you’re looking for or ask a question', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_see_details'                                         => __( 'See details', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_wordpress_version'                                   => __( 'WordPress version', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_php_version'                                         => __( 'PHP version', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_active_theme'                                        => __( 'Active theme', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_review'                                              => __( 'Review', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_plugins'                                             => __( 'Plugins', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_updates'                                             => __( 'updates', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_your_website'                                        => __( 'Your website', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_live'                                                => __( 'Live', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_edit_website'                                        => __( 'Edit website', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_overview'                                            => __( 'Overview', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_domain'                                              => __( 'Domain', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_hosting_plan'                                        => __( 'Hosting plan', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_your_domain'                                         => __( 'Your domain', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_domain_address'                                       => __( 'Domain address', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_expiration_date'                                     => __( 'Expiration date', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_resources'                                             => __( 'Resources', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_plan_essentials'                                      => __( 'Plan essentials', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_manage_plan'                                           => __( 'Manage plan', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_manage_resources'                                      => __( 'Manage resources', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_plan'                                                    => __( 'Plan', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_storage'                                                 => __( 'Storage', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_files'                                                   => __( 'Files', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_databases'                                               => __( 'Databases', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_domain_status_active_title'                              => __( 'Your domain is active', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_domain_status_active_description'                        => __( 'Your domain is set up and pointing to your website. Visitors can reach your site at this address.', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_domain_status_suspended_title'                           => __( 'Your domain is suspended', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_domain_status_suspended_description'                     => __( 'Your domain has been temporarily disabled, so your website can’t be reached. This usually happens when required details need to be confirmed. Contact support to get it reactivated.', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_domain_status_connecting_title'                          => __( 'Connecting your domain', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_domain_status_connecting_description'                    => __( 'We’re linking your domain to your website. This can take a little while, so no action is needed right now.', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_domain_status_not_connected_external_title'              => __( 'Domain not connected yet', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_domain_status_not_connected_external_description'        => __( 'Your domain is registered with another provider and isn’t pointing to your website yet. Update its nameservers or DNS records to connect it.', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_domain_status_not_connected_internal_title'              => __( 'Domain not connected yet', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_domain_status_not_connected_internal_description'        => __( 'Your domain isn’t pointing to this website yet. Finish connecting it so visitors can reach your site at this address.', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_domain_status_temporary_title'                           => __( 'Using a temporary domain', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_domain_status_temporary_description'                     => __( 'Your website is live on a temporary address for now. Connect your own domain to give your site a permanent web address.', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_domain_status_temporary_expired_title'                   => __( 'Temporary domain expired', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_domain_status_temporary_expired_description'             => __( 'The temporary address for your website has expired and is no longer working. Connect your own domain to make your site reachable again.', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_domain_status_not_purchased_title'                       => __( 'No domain yet', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_domain_status_not_purchased_description'                 => __( 'You haven’t added a domain to your website. Buy or connect one to give your site its own web address.', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_domain_status_expired_grace_title'                       => __( 'Your domain has expired', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_domain_status_expired_grace_description'                 => __( 'Your domain expired but can still be renewed at the normal price for a short time. Renew it now to keep your address and avoid losing it.', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_domain_status_expired_restore_title'                     => __( 'Your domain needs to be restored', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_domain_status_expired_restore_description'               => __( 'The renewal window has passed, but you can still recover your domain for a limited time for an extra fee. Restore it now before it’s released to the public.', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_domain_status_expires_soon_title'                        => __( 'Your domain expires soon', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_domain_status_expires_soon_description'                  => __( 'Your domain is about to expire. Renew it now to keep your website online and avoid any interruption.', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_domain_status_transfer_title'                            => __( 'Domain transfer in progress', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_domain_status_transfer_description'                      => __( 'Your domain is being transferred to Hostinger. This can take a few days to complete, and no action is needed from you right now.', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_domain_status_reviewing_title'                           => __( 'Reviewing your domain', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_domain_status_reviewing_description'                     => __( 'We’re checking the details of your domain registration. This is usually quick, and we’ll let you know once it’s done.', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_domain_status_failed_registration_title'                 => __( 'Domain registration failed', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_domain_status_failed_registration_description'           => __( 'We couldn’t register your domain. Please try again, and contact support if the problem continues.', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_domain_status_registering_title'                         => __( 'Registering your domain', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_domain_status_registering_description'                   => __( 'We’re registering your domain now. This usually takes a few minutes, so no action is needed right now.', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_domain_status_finish_registration_title'                 => __( 'Finish registering your domain', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_domain_status_finish_registration_description'           => __( 'Your domain registration needs a few more details from you to be completed. Finish the remaining steps to activate it.', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_domain_status_loading_title'                             => __( 'Checking your domain', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_domain_status_loading_description'                       => __( 'We’re loading your domain details. This will only take a moment.', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_domain_status_expired_title'                             => __( 'Your domain has expired', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_domain_status_expired_description'                       => __( 'Your domain expired and your website can no longer be reached at this address. Renew it to bring your site back online.', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_domain_status_pending_email_verification_title'          => __( 'Verify your email address', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_domain_status_pending_email_verification_description'    => __( 'Your domain can’t go live until you confirm your email address. Check your inbox and click the verification link we sent you.', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_domain_status_pending_phone_verification_title'          => __( 'Verify your phone number', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_domain_status_pending_phone_verification_description'    => __( 'Your domain can’t go live until you confirm your phone number. Follow the verification steps to finish setting it up.', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_domain_status_default_title'                             => __( 'Domain status unavailable', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_domain_status_default_description'                       => __( 'We couldn’t determine the current status of your domain. Refresh the page, or contact support if this keeps happening.', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_hosting_status_expiration_normal_title'                  => __( 'Your hosting plan expires soon', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_hosting_status_expiration_normal_description'            => __( 'Your hosting plan is approaching its renewal date. Renew it now to keep your website online and avoid any interruption.', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_hosting_status_expiration_urgent_title'                  => __( 'Your hosting plan expires in a few days', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_hosting_status_expiration_urgent_description'            => __( 'Your hosting plan expires in just a few days. Renew it now so your website stays online without interruption.', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_hosting_status_expiration_critical_title'                => __( 'Your hosting plan expires very soon', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_hosting_status_expiration_critical_description'          => __( 'Your hosting plan is about to expire and your website could go offline at any moment. Renew it now to keep your site running.', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_hosting_status_expiration_expired_title'                 => __( 'Your hosting plan has expired', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_hosting_status_expiration_expired_description'           => __( 'Your hosting plan expired and your website may go offline. Renew it now to bring your site back online and keep it running.', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_hosting_status_disk_normal_title'                        => __( 'Storage is almost full', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_hosting_status_disk_normal_description'                  => __( 'Your website is close to its storage limit. Free up space or upgrade your plan to keep everything running smoothly.', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_hosting_status_disk_limit_reached_title'                 => __( 'Storage limit reached', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_hosting_status_disk_limit_reached_description'           => __( 'Your website has used all available storage. Free up space or upgrade your plan so new files can be saved.', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_hosting_status_inodes_normal_title'                      => __( 'File limit almost reached', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_hosting_status_inodes_normal_description'                => __( 'Your website is close to its file limit. Remove unused files or upgrade your plan to stay within the limit.', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_hosting_status_inodes_limit_reached_title'               => __( 'File limit reached', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_hosting_status_inodes_limit_reached_description'         => __( 'Your website has reached its file limit. Remove unused files or upgrade your plan so new files can be added.', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_hosting_status_database_normal_title'                    => __( 'Database limit almost reached', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_hosting_status_database_normal_description'              => __( 'Your database is close to its size limit. Clean up unused data or upgrade your plan to avoid issues.', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_hosting_status_database_limit_reached_title'             => __( 'Database limit reached', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_hosting_status_database_limit_reached_description'       => __( 'Your database has reached its size limit. Clean up unused data or upgrade your plan so your website can keep running smoothly.', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_hosting_status_active_title'                             => __( 'Your hosting plan is active', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_hosting_status_active_description'                       => __( 'Your hosting plan is running normally. No action is needed right now.', 'hostinger-easy-onboarding' ),
                ),
                ...
                'installed_plugins'       => array_map( 'dirname', array_keys( $all_plugins ) ),
                'active_plugins'          => array_values( array_map( 'dirname', array_filter( array_keys( $all_plugins ), 'is_plugin_active' ) ) ),
                'active_plugins_v2'     => array_values( array_map( function( $plugin ) use ( $all_plugins, $plugin_updates ) {
                    return array(
                        'name' => $plugin,
                        'slug' => dirname( $plugin ),
                        'current_version' => $all_plugins[ $plugin ]['Version'],
                        'update_version' => isset( $plugin_updates[ $plugin ]->new_version ) ? $plugin_updates[ $plugin ]->new_version : null,
                        'is_update_available' => isset( $plugin_updates[ $plugin ] ),
                    );
                }, array_filter( array_keys( $all_plugins ), 'is_plugin_active' ) ) ),
                'active_theme'            => array(
                    'slug'  => get_stylesheet(),
    ...
    private function is_onboarding_admin_page(): bool {
