...
- Fix: Incorrect links to hostinger
- Fix: Hostinger Hub steps section UX update
- Feature: Hostinger Hub: Hosting section
- Feature: Hostinger hub domain section
- Feature: Hostinger hub: Your website overview section
- Feature: Hostinger Hub: Add Kodee window

2.1.36 (2026-08-25)

- Tweak: Update dependencies
- Tweak: Rename Kodee to Hostinger Agent

2.1.35 (2026-08-20)

- Feature: Add finish setup button Elementor
- Feature: Steps section substeps
- Tweak: Bump Tested Up to WP 7.1
- Tweak: Update dependencies
- Feature: Added steps section to Hostinger Hub
- Feature: Hostinger Hub
- Feature: Update dependencies

2.1.34 (2026-08-06)

- Fix: Modal options for allowOverflow

2.1.33 (2026-07-23)

- Feature: Prevent WPForms wizard redirect

2.1.32 (2026-07-21)

- Feature: Change add domain url

2.1.31 (2026-07-07)
- Fix: Small mobile issues
- Tweak: Update dependencies
...
2.1.29 (2026-06-30)
- Feature: Improved connect domain flow

2.1.28 (2026-06-25)
- Version bump: PATCH

2.1.27 (2026-06-23)
- Feature: Remove exposure event call on init

2.1.26 (2026-06-18)
- Feature: Send locale in plugins requests
- Feature: Removed addons banner

2.1.25 (2026-06-16)
- Fix: Update dependencies
- Fix: Update onboarding step order
- Feature: Enhance plugins modal visuals
- Fix: Missing translations

2.1.24 (2026-06-01)
- Feature: Add Email upsell step
- Feature: Update translations

2.1.23 (2026-05-26)
- Fix: Redirect to AI Builder
- Feature: Add onboarding redirect
- Fix: Add domain step on preview domains
- Fix: Assets loading on other plugin pages
