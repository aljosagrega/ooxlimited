...
if ( !lxdb_is_cmb2_activated() ) return;

if ( ! class_exists( 'LXDB_CMB2_Conditionals', false ) ) {

	/**
	 * LXDB_CMB2_Conditionals Plugin.
	 */
	class LXDB_CMB2_Conditionals {
		...
		public function admin_footer() {
			...
			$script_src = apply_filters( 'cmb2_conditionals_enqueue_script_src', LXDB_PLUGIN_URL . 'assets/js/cmb2-conditionals.min.js' );
	...
	if ( ! function_exists( 'cmb2_conditionals_init' ) ) {
		...
		function cmb2_conditionals_init() {
			...
			if ( null === $cmb2_conditionals ) {
				$cmb2_conditionals = new LXDB_CMB2_Conditionals();
			}
