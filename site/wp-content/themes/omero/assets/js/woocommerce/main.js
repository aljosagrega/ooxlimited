(function ($) {
    ...
    function tooltip() {
        $('body').on('mouseenter', '.group-action .add_to_cart:not(.tooltipstered), .group-action .woosw-btn:not(.tooltipstered), .group-action .woosq-btn:not(.tooltipstered), .group-action .woosc-btn:not(.tooltipstered)', function () {
            ...
            if (typeof $.fn.tooltipster !== 'undefined') {
                var pos = ($element.closest('li.product').hasClass('product-list')) ? 'right' : 'left';
                $element.tooltipster({
    ...
    function product_swatches_attr_image() {
        $('body').on('click', '.product-block .omero-product-swatches, .product-list .omero-product-swatches', function () {
            var image = $(this).data('image');
    ...
    function quick_product_variable() {
        ...
        $(document).on('click', btnSelector, function (e) {
            ...
            if ($product.hasClass('quick-shop-loaded')) {
                ...
                $('body').trigger('omero-quick-view-displayed');
                return;
            }
            ...
            $.ajax({
                url: omeroAjax.ajaxurl, data: {
                    action: 'omero_quick_shop', id: id,
            ...
            // Ajax action.
            xhr = $.ajax({
                url: wc_add_to_cart_params.wc_ajax_url.toString().replace('%%endpoint%%', 'omero_add_to_cart'),
                data: formData,
                type: 'POST',
                processData: false,
                contentType: false,
