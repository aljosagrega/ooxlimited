...
class Omero_Elementor_Custom_Css {
        ...
        add_action('elementor/element/container/section_layout_container/before_section_end', function ($container) {
            $container->add_responsive_control(
                ...
                [
                    ...
                    'description' => esc_html__( 'Fix height for Container', 'omero' ),
                    'selectors' => [
    ...
    public function add_scripts_editor() {
        ...
        wp_enqueue_script( 'omero-elementor-custom-css', get_theme_file_uri( '/assets/js/elementor-addon/elementor-custom-css'.$suffix.'.js' ), [], $omero_version, true );
    }
    ...
    public function register_controls( Controls_Stack $element, $section_id ) {
        ...
        $element->start_controls_section(
            'section_custom_css',
            [
                'label' => esc_html__( 'Custom CSS', 'omero' ),
                'tab' => $old_section['tab'],
            ]
        );
        ...
        $element->add_control(
            'custom_css_title',
            [
                'raw' => esc_html__( 'Add your own custom CSS here', 'omero' ),
        ...
        $element->add_control(
            ...
            [
                'raw' => wp_kses_post(__( 'Use "selector" to target wrapper element. Examples:<br>selector {color: red;} // For main element<br>selector .child-element {margin: 10px;} // For child element<br>.my-class {text-align: center;} // Or use any custom selector', 'omero' )),
                'type' => Controls_Manager::RAW_HTML,
...
return new Omero_Elementor_Custom_Css();
