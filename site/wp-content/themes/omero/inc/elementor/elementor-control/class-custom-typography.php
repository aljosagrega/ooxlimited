 ...
 * @since 1.0.0
 */
class Omero_Group_Control_Typography extends Group_Control_Base {
	...
	protected function init_fields() {
		...
		$fields['font_family'] = [
			'label' => esc_html_x( 'Family', 'Typography Control', 'omero' ),
		...
		$fields['font_size'] = [
			'label' => esc_html_x( 'Size', 'Typography Control', 'omero' ),
		...
		$fields['line'] = [
			'label' => esc_html_x( 'Line Text', 'Typography Control', 'omero' ),
		...
		$fields['font_weight'] = [
			'label' => esc_html_x( 'Weight', 'Typography Control', 'omero' ),
			'type' => Controls_Manager::SELECT,
			'default' => '',
			'options' => [
				'100' => '100 ' . esc_html_x( '(Thin)', 'Typography Control', 'omero' ),
				'200' => '200 ' . esc_html_x( '(Extra Light)', 'Typography Control', 'omero' ),
				'300' => '300 ' . esc_html_x( '(Light)', 'Typography Control', 'omero' ),
				'400' => '400 ' . esc_html_x( '(Normal)', 'Typography Control', 'omero' ),
				'500' => '500 ' . esc_html_x( '(Medium)', 'Typography Control', 'omero' ),
				'600' => '600 ' . esc_html_x( '(Semi Bold)', 'Typography Control', 'omero' ),
				'700' => '700 ' . esc_html_x( '(Bold)', 'Typography Control', 'omero' ),
				'800' => '800 ' . esc_html_x( '(Extra Bold)', 'Typography Control', 'omero' ),
				'900' => '900 ' . esc_html_x( '(Black)', 'Typography Control', 'omero' ),
				'' => esc_html__( 'Default', 'omero' ),
				'normal' => esc_html__( 'Normal', 'omero' ),
				'bold' => esc_html__( 'Bold', 'omero' ),
			],
		];

		$fields['text_transform'] = [
			'label' => esc_html_x( 'Transform', 'Typography Control', 'omero' ),
			'type' => Controls_Manager::SELECT,
			'default' => '',
			'options' => [
				'' => esc_html__( 'Default', 'omero' ),
				'uppercase' => esc_html_x( 'Uppercase', 'Typography Control', 'omero' ),
				'lowercase' => esc_html_x( 'Lowercase', 'Typography Control', 'omero' ),
				'capitalize' => esc_html_x( 'Capitalize', 'Typography Control', 'omero' ),
				'none' => esc_html__( 'Normal', 'omero' ),
			],
		];

		$fields['font_style'] = [
			'label' => esc_html_x( 'Style', 'Typography Control', 'omero' ),
			'type' => Controls_Manager::SELECT,
			'default' => '',
			'options' => [
				'' => esc_html__( 'Default', 'omero' ),
				'normal' => esc_html__( 'Normal', 'omero' ),
				'italic' => esc_html_x( 'Italic', 'Typography Control', 'omero' ),
				'oblique' => esc_html_x( 'Oblique', 'Typography Control', 'omero' ),
			],
		];

		$fields['text_decoration'] = [
			'label' => esc_html_x( 'Decoration', 'Typography Control', 'omero' ),
			'type' => Controls_Manager::SELECT,
			'default' => '',
			'options' => [
				'' => esc_html__( 'Default', 'omero' ),
				'underline' => esc_html_x( 'Underline', 'Typography Control', 'omero' ),
				'overline' => esc_html_x( 'Overline', 'Typography Control', 'omero' ),
				'line-through' => esc_html_x( 'Line Through', 'Typography Control', 'omero' ),
				'none' => esc_html__( 'None', 'omero' ),
			],
		];

		$fields['line_height'] = [
			'label' => esc_html__( 'Line Height', 'omero' ),
			'type' => Controls_Manager::SLIDER,
			'desktop_default' => [
				'unit' => 'em',
			],
		...
		$fields['letter_spacing'] = [
			'label' => esc_html__( 'Letter Spacing', 'omero' ),
			'type' => Controls_Manager::SLIDER,
			'size_units' => [ 'px', 'em', 'rem', 'custom' ],
			'range' => [
				'px' => [
		...
		$fields['word_spacing'] = [
			'label' => esc_html__( 'Word Spacing', 'omero' ),
			'type' => Controls_Manager::SLIDER,
			'size_units' => [ 'px', 'em', 'rem', 'custom' ],
			'range' => [
				'px' => [
	...
	protected function get_default_options() {
		return [
			'popover' => [
				...
				'starter_title' => esc_html__( 'Typography', 'omero' ),
				'settings' => [
					'render_type' => 'ui',
