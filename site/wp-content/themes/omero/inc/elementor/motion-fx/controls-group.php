...
class Omero_Elementor_Control_MotionFX extends Group_Control_Base {
	...
	protected function init_fields() {
		$fields = [
			'motion_fx_scrolling' => [
				'label' => esc_html__( 'Scrolling Effects', 'omero' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => esc_html__( 'Off', 'omero' ),
				'label_on' => esc_html__( 'On', 'omero' ),
				'render_type' => 'ui',
		...
		$fields['transform_origin_x'] = [
			'label' => esc_html__( 'X Anchor Point', 'omero' ),
		...
		$fields['transform_origin_y'] = [
			'label' => esc_html__( 'Y Anchor Point', 'omero' ),
			'type' => Controls_Manager::CHOOSE,
			'default' => 'center',
			'options' => [
				'top' => [
		...
		foreach ( $active_devices as $device_key ) {
			$device_label = 'desktop' === $device_key ? esc_html__( 'Desktop', 'omero' ) : $active_breakpoint_instances[ $device_key ]->get_label();

			$devices_options[ $device_key ] = $device_label;
		}

		$fields['devices'] = [
			'label' => esc_html__( 'Apply Effects On', 'omero' ),
		...
		$fields['range'] = [
			'label' => esc_html__( 'Effects Relative To', 'omero' ),
			'type' => Controls_Manager::SELECT,
			'options' => [
				'' => esc_html__( 'Default', 'omero' ),
				'viewport' => esc_html__( 'Viewport', 'omero' ),
				'page' => esc_html__( 'Entire Page', 'omero' ),
			],
			'condition' => [
				'motion_fx_scrolling' => 'yes',
			],
		...
		$fields['motion_fx_mouse'] = [
			'label' => esc_html__( 'Mouse Effects', 'omero' ),
			'type' => Controls_Manager::SWITCHER,
			'label_off' => esc_html__( 'Off', 'omero' ),
			'label_on' => esc_html__( 'On', 'omero' ),
			'separator' => 'before',
	...
	private function get_scrolling_effects() {
		return [
			'translateY' => [
				'label' => esc_html__( 'Vertical Scroll', 'omero' ),
				'fields' => [
					'direction' => [
						...
						'options' => [
							'' => esc_html__( 'Up', 'omero' ),
							'negative' => esc_html__( 'Down', 'omero' ),
						],
					],
					'speed' => [
					...
					'affectedRange' => [
						'label' => esc_html__( 'Viewport', 'omero' ),
						'type' => Controls_Manager::SLIDER,
						'default' => [
							'sizes' => [
								'start' => 0,
			...
			'translateX' => [
				'label' => esc_html__( 'Horizontal Scroll', 'omero' ),
				'fields' => [
					'direction' => [
						'label' => esc_html__( 'Direction', 'omero' ),
						'type' => Controls_Manager::SELECT,
						'options' => [
							'' => esc_html__( 'To Left', 'omero' ),
							'negative' => esc_html__( 'To Right', 'omero' ),
						],
					],
					'speed' => [
						'label' => esc_html__( 'Speed', 'omero' ),
			...
			'opacity' => [
				'label' => esc_html__( 'Transparency', 'omero' ),
				'fields' => [
					'direction' => [
						'label' => esc_html__( 'Direction', 'omero' ),
						'type' => Controls_Manager::SELECT,
	...
	private function get_mouse_effects() {
		return [
			'mouseTrack' => [
				'label' => esc_html__( 'Mouse Track', 'omero' ),
				'fields' => [
					'direction' => [
						'label' => esc_html__( 'Direction', 'omero' ),
						'type' => Controls_Manager::SELECT,
						'default' => '',
						'options' => [
							'' => esc_html__( 'Opposite', 'omero' ),
							'negative' => esc_html__( 'Direct', 'omero' ),
						],
					],
					'speed' => [
						'label' => esc_html__( 'Speed', 'omero' ),
			...
			'tilt' => [
				'label' => esc_html__( '3D Tilt', 'omero' ),
				'fields' => [
					'direction' => [
						'label' => esc_html__( 'Direction', 'omero' ),
						'type' => Controls_Manager::SELECT,
						'default' => '',
						'options' => [
							'' => esc_html__( 'Direct', 'omero' ),
							'negative' => esc_html__( 'Opposite', 'omero' ),
						],
					],
					'speed' => [
						'label' => esc_html__( 'Speed', 'omero' ),
