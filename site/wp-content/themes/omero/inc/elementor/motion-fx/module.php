...
class Omero_Elementor_MotionFX {
	...
	public function register_controls_group() {
        \Elementor\Plugin::instance()->controls_manager->add_group_control( 'motion_fx', new Omero_Elementor_Control_MotionFX() );
	}
	...
	public function add_controls_group_to_element( Element_Base $element ) {
		...
		$element->add_group_control(
            Omero_Elementor_Control_MotionFX::get_type(),
			[
				'name' => 'motion_fx',
				'selector' => $selector,
				'exclude' => $exclude,
