...
class Omero_Call_To_Action extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Omero Banner', 'omero');
    }
    ...
    protected function register_controls( $args = [] ) {
        ...
        $this->add_control(
            'bg_image',
            [
                'label'   => esc_html__('Choose Background Image', 'omero'),
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label'     => esc_html__('Image Resolution', 'omero'),
                'default'   => 'large',
                'separator' => 'none',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => esc_html__('This is the sub title', 'omero'),
        ...
        $this->add_control(
            'sub_title_position',
            [
                'label'        => __('Position Sub Title', 'omero'),
        ...
        $this->add_control(
            'title',
            [
                'label'       => esc_html__('Heading 1', 'omero'),
                'type'        => Controls_Manager::TEXT,
                'dynamic'     => [
                    'active' => true,
                ],
                'default'     => esc_html__('This is the heading 1', 'omero'),
                'placeholder' => esc_html__('Enter your heading 1', 'omero'),
                'label_block' => true,
                'separator'   => 'before',
            ]
        );
        ...
        $this->add_control(
            'heading2',
            [
                'label'       => esc_html__('Heading 2', 'omero'),
                'type'        => Controls_Manager::TEXT,
                'dynamic'     => [
                    'active' => true,
                ],
                'default'     => esc_html__('This is the heading 2', 'omero'),
                'placeholder' => esc_html__('Enter your heading 2', 'omero'),
                'label_block' => true,
                'separator'   => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => esc_html__('Lorem ipsum dolor sit amet consectetur adipiscing elit dolor', 'omero'),
                'placeholder' => esc_html__('Enter your description', 'omero'),
                'separator'   => 'none',
                'rows'        => 5,
            ]
        );
        ...
        $this->add_control(
            'button_show',
            [
                'label'     => esc_html__('Button Show', 'omero'),
        ...
        $this->add_control(
            'link_click',
            [
                'label'     => esc_html__('Apply Link On', 'omero'),
                'type'      => Controls_Manager::SELECT,
                'options'   => [
                    'box'    => esc_html__('Whole Box', 'omero'),
                    'button' => esc_html__('Button Only', 'omero'),
                ],
                'default'   => 'button',
                'separator' => 'none',
                'condition' => [
        ...
        $this->add_control(
            'content-stretch',
            [
                'label'        => esc_html__('Stretch', 'omero'),
                'type'         => Controls_Manager::SWITCHER,
        ...
        $this->add_responsive_control(
            'Horizontal_align',
            [
                'label'     => esc_html__('Horizontal Align', 'omero'),
        ...
        $this->add_control(
            'background_gradient',
            [
                'label'        => esc_html__('Background Gradient', 'omero'),
                'type'         => Controls_Manager::SWITCHER,
        ...
        $this->add_responsive_control(
            'inner_padding',
            [
                'label'      => esc_html__('Padding Content', 'omero'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', 'em'],
                'selectors'  => [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default'      => '',
                'selectors'    => [
                    '{{WRAPPER}}.elementor-widget-omero-banner.box-align-center .elementor-cta .elementor-cta__content' => 'text-align: {{VALUE}}',
                ],
        ...
        $this->add_control(
            'title_color',
            [
                'label'     => esc_html__('Heading Color', 'omero'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'heading2_color',
            [
                'label'     => esc_html__('Heading2 Color', 'omero'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'subtitle_color',
            [
                'label'     => esc_html__('Sub title Color', 'omero'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'description_color',
            [
                'label'     => esc_html__('Description Color', 'omero'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_section(
            'image_layer_style',
            [
                'label'     => esc_html__('Image Layer', 'omero'),
                'tab'       => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'show_img_layer' => 'yes',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'default'      => 'default',
                'prefix_class' => 'button-banner-style-omero-',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'        => esc_html__('Position Bottom', 'omero'),
                'type'         => Controls_Manager::SWITCHER,
                'condition'    => [
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Box Text Color', 'omero'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_section(
            'hover_effects',
            [
                'label' => esc_html__('Hover Effects', 'omero'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            'transformation',
            [
                'label'        => esc_html__('Hover Animation', 'omero'),
                'type'         => Controls_Manager::SELECT,
                'options'      => [
                    ''                  => 'None',
                    'zoom-in'           => 'Zoom In',
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector'       => '{{WRAPPER}}.elementor-widget-omero-banner:not(:hover) .elementor-cta__bg-overlay',
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}}.elementor-widget-omero-banner:hover .elementor-cta__bg',
            ]
        );
        ...
        $this->add_control(
            'effect_duration',
            [
                'label'       => esc_html__('Transition Duration', 'omero'),
                'type'        => Controls_Manager::SLIDER,
        ...
        <?php if ($print_bg) : ?>
            <div class="elementor-cta__bg-wrapper">
                ...
                <?php if (isset($settings['show_img_layer']) && $settings['show_img_layer'] === 'yes' && !empty($image_layer)) : ?>
                    <figure class="elementor-cta_image_layer omero-e-transform">
...
$widgets_manager->register(new Omero_Call_To_Action());
