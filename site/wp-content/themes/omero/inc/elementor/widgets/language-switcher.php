 ...
 * @since 1.0.0
 */
class Omero_Elementor_Language_Switcher extends Elementor\Widget_Base
{
    ...
    {
        return 'omero-language-switcher';
    }
    ...
    {
        return esc_html__('Language Switcher', 'omero');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'typography',
                'selector' => '{{WRAPPER}} .omero-language-switcher span.title',
            ]
        );
        ...
        $this->add_control(
            'label_color',
            [
                'label' => esc_html__('Label Color', 'omero'),
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .omero-language-switcher .item > div i' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'hover_right',
            [
                'label' => esc_html__('Hover Right', 'omero'),
    ...
    {
        omero_language_switcher();
    }
}

$widgets_manager->register(new Omero_Elementor_Language_Switcher());
