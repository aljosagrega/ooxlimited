...
class Omero_Post_Navigation extends Elementor\Widget_Base {

	public function get_name() {
		return 'omero-post-navigation';
	}

	public function get_title() {
		return esc_html__( 'Omero Post Navigation', 'omero' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Post Navigation', 'omero' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'label_on' => esc_html__( 'Show', 'omero' ),
				'label_off' => esc_html__( 'Hide', 'omero' ),
				'default' => 'yes',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_html__( 'Previous', 'omero' ),
				'condition' => [
					'show_label' => 'yes',
				],
			]
		...
		$this->add_control(
			'arrow',
			[
				'label' => esc_html__( 'Arrows Type', 'omero' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'fa fa-angle-left' => esc_html__( 'Angle', 'omero' ),
					'fa fa-angle-double-left' => esc_html__( 'Double Angle', 'omero' ),
					'fa fa-chevron-left' => esc_html__( 'Chevron', 'omero' ),
					'fa fa-chevron-circle-left' => esc_html__( 'Chevron Circle', 'omero' ),
					'fa fa-caret-left' => esc_html__( 'Caret', 'omero' ),
					'fa fa-arrow-left' => esc_html__( 'Arrow', 'omero' ),
					'fa fa-long-arrow-left' => esc_html__( 'Long Arrow', 'omero' ),
					'fa fa-arrow-circle-left' => esc_html__( 'Arrow Circle', 'omero' ),
					'fa fa-arrow-circle-o-left' => esc_html__( 'Arrow Circle Negative', 'omero' ),
				],
		...
		$this->add_control(
			'show_title',
			[
				'label' => esc_html__( 'Post Title', 'omero' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', 'omero' ),
				'label_off' => esc_html__( 'Hide', 'omero' ),
				'default' => 'yes',
		...
		$this->add_control(
			'show_borders',
			[
				'label' => esc_html__( 'Borders', 'omero' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', 'omero' ),
				'label_off' => esc_html__( 'Hide', 'omero' ),
				'default' => 'yes',
		...
		$this->add_control(
			'in_same_term',
			[
				'label' => esc_html__( 'In same Term', 'omero' ),
				'type' => Controls_Manager::SELECT2,
				'options' => $post_type_options,
				'default' => '',
				'multiple' => true,
				'label_block' => true,
				'description' => esc_html__( 'Indicates whether next post must be within the same taxonomy term as the current post, this lets you set a taxonomy per each post type', 'omero' ),
			]
		);
		...
		foreach ( $post_type_options as $post_type => $post_type_label ) {
			$this->add_control(
				$post_type . '_taxonomy',
				[
					'label' => $post_type_label . ' ' . esc_html__( 'Taxonomy', 'omero' ),
					'type' => Controls_Manager::SELECT,
	...
	protected function render() {
		...
		if ( 'yes' === $settings['show_arrow'] ) {
			...
			$prev_arrow = '<span class="post-navigation__arrow-wrapper post-navigation__arrow-prev"><i class="' . esc_attr( $prev_icon_class ) . '" aria-hidden="true"></i><span class="elementor-screen-only">' . esc_html__( 'Prev', 'omero' ) . '</span></span>';
			$next_arrow = '<span class="post-navigation__arrow-wrapper post-navigation__arrow-next"><i class="' . esc_attr( $next_icon_class ) . '" aria-hidden="true"></i><span class="elementor-screen-only">' . esc_html__( 'Next', 'omero' ) . '</span></span>';
		}
...
$widgets_manager->register(new Omero_Post_Navigation());
