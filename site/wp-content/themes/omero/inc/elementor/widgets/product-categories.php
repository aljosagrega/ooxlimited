...
/**
 * Elementor Omero_Elementor_Products_Categories
 * @since 1.0.0
 */
class Omero_Elementor_Products_Categories extends Omero_Base_Widgets {
    ...
    public function get_name() {
        return 'omero-product-categories';
    }
    ...
    public function get_title() {
        return esc_html__('Omero Product Categories', 'omero');
    }
    ...
    public function get_script_depends() {
        return ['omero-elementor-product-categories'];
    }
    ...
    protected function register_controls() {
        ...
        $repeater->add_control(
            'category_image_products',
            [
                'label'      => esc_html__('Choose Image Products', 'omero'),
        ...
        $repeater->add_control(
            'categories_name',
            [
                'label' => esc_html__('Alternate Name', 'omero'),
        ...
        $this->add_control(
            ...
            [
                ...
                'options'      => [
                    ...
                    '3' => esc_html__('Style 3', 'omero'),
                    '4' => esc_html__('Style 4', 'omero'),
                ],
        ...
        $this->add_control('show_count',
            [
                'label' => esc_html__('Show Count', 'omero'),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Show Button', 'omero'),
                'type'  => Controls_Manager::SWITCHER,
                'default' => 'yes',
                'condition'   => [
                    'style!' => '4'
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'vh'], 
                'selectors'  => [
                    '{{WRAPPER}} .elementor-categories-item' => 'height: {{SIZE}}{{UNIT}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .elementor-categories-item' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .elementor-categories-item' => 'opacity: {{SIZE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .elementor-categories-item:hover' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .elementor-categories-item:hover' => 'opacity: {{SIZE}};',
                ],
            ]
        );
        ...
        $this->end_controls_tabs();
         ...
         $this->add_responsive_control(
            'effects_width',
            [
                'label'          => esc_html__('Width Effects', 'omero'),
                'type'           => Controls_Manager::SLIDER,
                'default'        => [
                    'unit' => '%',
                ],
        ...
        $this->add_responsive_control(
            'image_max_width',
            [
                'label'          => esc_html__('Max Width', 'omero'),
                'type'           => Controls_Manager::SLIDER,
                'default'        => [
                    'unit' => '%',
                ],
        ...
        $this->add_responsive_control(
            'image_object_fit',
            [
                'label'     => esc_html__('Object Fit', 'omero'),
                'type'      => Controls_Manager::SELECT,
                'condition' => [
                    'image_height[size]!' => '',
                ],
                'options'   => [
                    ...
                    'fill'    => esc_html__('Fill', 'omero'),
                    'cover'   => esc_html__('Cover', 'omero'),
                    'contain' => esc_html__('Contain', 'omero'),
                ],
                'default'   => '',
                'selectors' => [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'    => [
                    ...
                    '{{WRAPPER}} .category-product-top-info' => 'justify-content: {{VALUE}} ;',
                ],
            ]
        );
        ...
        $this->start_controls_section(
            'products_image_section_style',
            [
                'label' => esc_html__('Image Product', 'omero'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_responsive_control(
            'products_spacing_x',
            [
                'label'      => esc_html__('Spacing X', 'omero'),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => ['px', '%'],
                'range'      => [
                    'px' => [
                ...
                'selectors'  => [
                    '{{WRAPPER}}.category-product-style-3 .category-image-products'   => 'bottom: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'products_spacing_y',
            [
                'label'      => esc_html__('Spacing Y', 'omero'),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => ['px', '%'],
                'range'      => [
                    'px' => [
                ...
                'selectors'  => [
                    '{{WRAPPER}}.category-product-style-3 .category-image-products'    => 'left: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->start_controls_section(
            'box_text_style',
            [
                'label' => esc_html__('Contents', 'omero'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_responsive_control('box_text_horizontal_position',
            [
                ...
                'selectors'  => [
                    '{{WRAPPER}}.category-product-style-4 .omero-con .omero-con-inner' => 'left: {{SIZE}}{{UNIT}}'
                ],
                'condition' => [
                    'style' => '4'
                ]
        ...
        $this->add_responsive_control('box_text_vertical_position',
            [
                ...
                'selectors'  => [
                    '{{WRAPPER}}.category-product-style-4 .omero-con .omero-con-inner' => 'top: {{SIZE}}{{UNIT}}'
                ],
                'condition' => [
                    'style' => '4'
                ]
         ...
         $this->add_responsive_control(
            ...
            [
                ...
                'selectors'  => [
                    ...
                    '{{WRAPPER}}.category-product-style-3 .category-product-caption ' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors'  => [
                        ...
                        '{{WRAPPER}}.category-product-style-3 .category-product-caption '=> 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
                    ],
                ]
            );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}}.elementor-widget-omero-product-categories .category-title a:hover' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            Omero_Group_Control_Typography::get_type(),
            [
                'name'     => 'category_sub_typography',
                'selector' => '{{WRAPPER}} .category-sub',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}} .category-sub' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .category-sub' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'total_color_text',
            [
                'label'     => esc_html__('Color Count Text', 'omero'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->add_control(
            'total_color',
            [
                'label'     => esc_html__('Color Count', 'omero'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
                        ...
                        <?php foreach ($settings['categories_list'] as $index => $item): ?>
                            ...
                            <div <?php $this->print_render_attribute_string('item'); ?>>
                                <?php if (empty($item['categories'])) {
                                    echo esc_html__('Choose Category', 'omero');
                                    return;
                                }
                                ...
                                if (!is_wp_error($category) && !empty($category)) {
                                    ...
                                    <div <?php $this->print_render_attribute_string($tab_title_setting_key); ?>>
                                        ...
                                        ?>
                                        <div class="category-image-products">
                                            <?php
                                            if (!empty($item['category_image_products']['id'])) {
                                                $item['category_image_products_size'] = 'full';
                                                $image_url = Group_Control_Image_Size::get_attachment_image_src($item['category_image_products']['id'], 'category_image_products', $item);
                                                printf('<img class="image-category-image-products" src="%s" alt="" >', esc_url($image_url));
                                            }
                                            ?>
                                        </div>
                                                    ...
                                                    <div class="category-product-top-info">
                                                        ...
                                                        <?php if ($settings['show_count']): ?>
                                                            <div class="category-count-wrapper">
                                                                ...
                                                                <span class="category-count-text"><?php echo esc_html__('products', 'omero') ?></span>
                                                            </div>
                                                        <?php endif; ?>
                                                    </div>
...
$widgets_manager->register(new Omero_Elementor_Products_Categories());
