 ...
 * @since 1.0.0
 */
class Omero_Elementor_Widget_Products_Recently extends \Elementor\Widget_Base {
    ...
    public function get_name() {
        return 'omero-products-recently';
    }
    ...
    public function get_title() {
        return esc_html__('Products Recently', 'omero');
    }
    ...
    protected function render() {
        ...
        if (empty($viewed_products)) {
            echo '<p class="recently-notice">' . esc_html__('There’s no item that you viewed recently.', 'omero') . '</p>';
            return;
        }
...
$widgets_manager->register(new Omero_Elementor_Widget_Products_Recently());
