...
class Omero_Elementor_Progress extends Widget_Progress {


    public function get_title() {
        return __('Omero Progress Bar', 'omero');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control('display_percentage', [
            'label'   => __('Display Percentage', 'omero'),
        ...
        $this->add_control(
            'progress_bg_color',
            [
                'label'     => __('Background Color Progress', 'omero'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .elementor-progress-wrapper .elementor-progress-bar' => 'background-color: {{VALUE}};',
                    '{{WRAPPER}} .elementor-progress-wrapper .elementor-progress-bar:before' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'title_margin',
            [
                'label'      => esc_html__('Title Margin', 'omero'),
        ...
        $this->start_controls_section(
            'section_percentage',
            [
                'label' => __('Percentage Style', 'omero'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Percentage Text', 'omero'),
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Percentage Color', 'omero'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_responsive_control(
            'percentage_margin',
            [
                'label'      => esc_html__('Percentage Margin', 'omero'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', 'em'],
                'selectors'  => [
...
$widgets_manager->register(new Omero_Elementor_Progress());