...
class Omero_Elementor_Vertiacl_Menu extends Elementor\Widget_Base
{
    ...
    {
        return 'omero-vertical-menu';
    }

    public function get_title()
    {
        return esc_html__('Omero Vertical Menu', 'omero');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'nav_vertiacl_layout',
            [
                'label' => esc_html__('Menu Layout', 'omero'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'style-1' => esc_html__('Dropdown', 'omero'),
                    'style-2' => esc_html__('Navbar', 'omero'),
                ],
                'default' => 'style-1',
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .vertical-navigation .vertical-navigation-header .omero-icon' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Color Icon Hover', 'omero'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
                    ...
                    '{{WRAPPER}} .vertical-navigation:hover .vertical-navigation-header .omero-icon' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control('vertical_menu_separator', [
            'label' => esc_html__('Separator', 'omero'),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Sub Menu', 'omero'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_group_control(
    ...
    protected function render()
    {
        ...
        <div <?php $this->print_render_attribute_string('wrapper'); ?>>
            <nav class="vertical-navigation" aria-label="<?php esc_attr_e('Vertiacl Navigation', 'omero'); ?>">
...
$widgets_manager->register(new Omero_Elementor_Vertiacl_Menu());
