...
/**
 * Class Omero_Elementor_Custom_Shapes
 *
 * Main Plugin class
 * @since 0.0.1
 */
class Omero_Elementor_Custom_Shapes {
    ...
    public function ecs_register_cpt() {
        ...
        $labels = array(
            'name'                  => _x('Custom shapes', 'Post Type General Name', 'omero'),
            'singular_name'         => _x('Custom shape', 'Post Type Singular Name', 'omero'),
            'menu_name'             => __('Custom shapes', 'omero'),
            'name_admin_bar'        => __('Custom shape', 'omero'),
            'archives'              => __('Item Archives', 'omero'),
            'attributes'            => __('Item Attributes', 'omero'),
            'parent_item_colon'     => __('Parent Item:', 'omero'),
            'all_items'             => __('All Items', 'omero'),
            'add_new_item'          => __('Add New Item', 'omero'),
            'add_new'               => __('Add New', 'omero'),
            'new_item'              => __('New Item', 'omero'),
            'edit_item'             => __('Edit Item', 'omero'),
            'update_item'           => __('Update Item', 'omero'),
            'view_item'             => __('View Item', 'omero'),
            'view_items'            => __('View Items', 'omero'),
            'search_items'          => __('Search Item', 'omero'),
            'not_found'             => __('Not found', 'omero'),
            'not_found_in_trash'    => __('Not found in Trash', 'omero'),
            'featured_image'        => __('Featured Image', 'omero'),
            'set_featured_image'    => __('Set featured image', 'omero'),
            'remove_featured_image' => __('Remove featured image', 'omero'),
            'use_featured_image'    => __('Use as featured image', 'omero'),
            'insert_into_item'      => __('Insert into item', 'omero'),
            'uploaded_to_this_item' => __('Uploaded to this item', 'omero'),
            'items_list'            => __('Items list', 'omero'),
            'items_list_navigation' => __('Items list navigation', 'omero'),
            'filter_items_list'     => __('Filter items list', 'omero'),
        );
        $args   = array(
            'label'               => __('Custom shape', 'omero'),
            'description'         => __('Custom shapes', 'omero'),
            'labels'              => $labels,
        ...
        omero_add_pt('ele_custom_shapes', $args);
    ...
    public function ecs_register_admin_menu() {
        $menu_title = _x('Custom Shapes', 'Elementor Custom Shapes', 'omero');
        add_submenu_page(
            'elementor',
            $menu_title,
            $menu_title,
...
Omero_Elementor_Custom_Shapes::instance();