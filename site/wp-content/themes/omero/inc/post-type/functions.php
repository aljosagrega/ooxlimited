...
if (!function_exists('omero_object_socials')) {
    function omero_object_socials() {
		$post_id = get_the_ID();
		$team_socials_group = get_post_meta($post_id, '_omero_socials_group', true);
		if($team_socials_group) { ?>
            <ol class="object_socials_list">
                <?php if(!empty($team_socials_group[0]['social_fb'])) { ?>
                    <li>
                        <a class="omero-icon-socical" href="<?php echo esc_url($team_socials_group[0]['social_fb']) ?>" target="_blank"><i class="omero-icon-facebook-f"></i></a>
                    </li>
                <?php } ?>
                <?php if(!empty($team_socials_group[0]['social_x'])) { ?>
                    <li>
                        <a class="omero-icon-socical" href="<?php echo esc_url($team_socials_group[0]['social_x']) ?>" target="_blank"><i class="omero-icon-twitter"></i></a>
                    </li>
                <?php } ?>
                <?php if(!empty($team_socials_group[0]['social_ig'])) { ?>
                    <li>
                        <a class="omero-icon-socical" href="<?php echo esc_url($team_socials_group[0]['social_ig']) ?>" target="_blank"><i class="omero-icon-tiktok"></i></a>
                    </li>
                <?php } ?>
                <?php if(!empty($team_socials_group[0]['social_in'])) { ?>
                    <li>
                        <a class="omero-icon-socical" href="<?php echo esc_url($team_socials_group[0]['social_in']) ?>" target="_blank"><i class="omero-icon-linkedin-in"></i></a>
                    </li>
                <?php } ?>
