<?php
/**
 * Omero_Product_Brand_List_Walker class
 *
 * @extends    Walker
 * @class        Omero_Product_Brand_List_Walker
 * @version        2.3.0
...
if (!class_exists('Omero_Product_Brand_List_Walker', false)) :

	class Omero_Product_Brand_List_Walker extends Walker {
