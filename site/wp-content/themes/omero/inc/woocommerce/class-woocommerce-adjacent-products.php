<?php
/**
 * Omero WooCommerce Adjacent Products Class
 *
 * @package  aro
 * @since    2.4.3
 */
...
if ( ! class_exists( 'Omero_WooCommerce_Adjacent_Products' ) ) :

	/**
	 * The Omero WooCommerce Adjacent Products Class
	 */
	class Omero_WooCommerce_Adjacent_Products {
		...
		private function query_wc() {
			...
			$products = wc_get_products( apply_filters( 'omero_woocommerce_adjacent_query_args', $args ) );
