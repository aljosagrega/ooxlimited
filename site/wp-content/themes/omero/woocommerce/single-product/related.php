...
if ($related_products) :
    ...
    $class = 'omero-theme-swiper omero-swiper-wrapper swiper ';
    ...
    $settings = omero_get_settings_product_caroseul();
    ...
    $carousel_enable = (omero_is_elementor_activated()) ? true : false;
    ...
    <section class="related products elementor-element">
        ...
        <?php
        $heading = apply_filters('woocommerce_product_related_products_heading', __('Related products', 'omero'));

        if ($heading) :
            ?>
            <h2><?php echo esc_html($heading); ?></h2>
            <span><?php _e('Follow the most popular trends and get exclusive items from shop', 'omero'); ?></span>
        <?php endif; ?>
        <div class="woocommerce <?php echo esc_attr($class); ?>" data-settings="<?php echo esc_attr(wp_json_encode($settings)) ?>">
            ...
            <?php if ($show_arrows) : ?>
                <div class="elementor-swiper-button elementor-swiper-button-prev related-swiper-button-prev">
                    <i aria-hidden="true" class="omero-icon-arrow-left"></i>
                ...
                <div class="elementor-swiper-button elementor-swiper-button-next related-swiper-button-next">
                    <i aria-hidden="true" class="omero-icon-arrow-right"></i>
        ...
        if (!omero_is_elementor_activated()) {
            ?>
            <style>
                .related .omero-products.products.elementor-grid {
                    display: flex;
                }
            </style>
            <?php
